...
['19', 'English 100 - No permission - Before 2000']
];
              ...
              items: [
                     {
						  ...
						  listeners: {
							blur: function(d) {
								var value = d.getValue().trim();
								checkNoolahamNumber(value);
							}
						 }
          				 },
      					 {  
                ...
                columnWidth: '.33',
            	 ...
            	 items: [
          				 ...
          				 },
                     {
						 ...
						 {
								xtype: 'textarea',
								fieldLabel: 'Scanning Qualtiy Notes',
								id: 'ScanningQualityNotes',
								multiline: true,		
								height: 40,
				  				tabIndex:29,                          
								anchor:'95%'
    ...
    items: [{
        ...
        items:[
              ...
              items:[
					...
					{
						xtype:'textfield',
						fieldLabel: 'Scanning Assistant',
						id: 'ScanningAssistant',
						tabIndex:12,
						anchor:'95%'					
					}				
          			]
...
function checkNoolahamNumber(value){
    Ext.Ajax.request({
        method: 'GET',
        url: 'php/Controller/MetaDataController.php',
		params: {action: 'checkNoolahamNumber', "NoolahamNumber": value},
        success: function( result, request){
			if (result.responseText == "Exists"){
				alert ("Please note a MetaData Record already exists for this NoolahamNumber.  Please edit that record instead of creating a new one");
				SelectedNode = "MetaDataRecords";
				setNode(SelectedNode);
			} 
        }
